...
/* ns1:getDataForBku */
struct ns1__getDataForBku
{
public:
	std::string _org_USCOREkd;	/* required element of type xsd:string */
	std::string _keterangan;	/* required element of type xsd:string */
...
/* ns1:setSppConfirmationResponse */
...
/* ns1:setSppConfirmation */
struct ns1__setSppConfirmation
{
public:
	std::string _xml_USCOREparams;	/* required element of type xsd:string */
};
#endif
